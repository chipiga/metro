[
  ...
  s = Station.new(:identifier => hash[:id], :color => hash[:color], :lat => hash[:coordinates][:lat], :lng => hash[:coordinates][:lng], :name => hash[:name])
  s.connected_to = hash[:connected_to] if hash[:connected_to]
  s.save
end